...
def main():
    ...
    tab1, tab2, tab3 = st.tabs(
        ["||___Home Page___||", "||___Test Report and Update___||", "||___Indiviual Patient Update___||",])
    ...
    with tab1:
        ...
        st.write(
            "3. Visit 'Indiviual Patient Update' page for collecting individual report.")
    ...
    with tab2:
        ...
        df_file = st.file_uploader('Upload a CSV', type=[
                                   'csv'], help='Only csv file is acceptable')
        ...
        if df_file is not None:
            ...
            st.download_button('Download updated file as CSV', data=csv,
                               file_name='updated_file.csv', mime='text/csv')
    ...
    with tab3:
        ...
        st.write(
            "If you want any individual patient's details kindly input his/her id below. ")
